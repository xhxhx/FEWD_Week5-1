...
Students should start by using the [starter code](starter_code/) and focus on adding the proper JavaScript to update the background of the page. The maximum possible score on this assignment is 28/28. Bonus materials are completely optional.
